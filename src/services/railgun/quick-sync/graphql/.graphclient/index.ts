...
import type { BscTypes } from './sources/bsc/types';
import type { GoerliTypes } from './sources/goerli/types';
import type { MumbaiTypes } from './sources/mumbai/types';
import type { ArbitrumOneTypes } from './sources/arbitrum-one/types';
import type { MaticTypes } from './sources/matic/types';
import type { EthereumTypes } from './sources/ethereum/types';
import type { ArbitrumGoerliTypes } from './sources/arbitrum-goerli/types';
...
export type MeshContext = MumbaiTypes.Context & BscTypes.Context & EthereumTypes.Context & MaticTypes.Context & ArbitrumGoerliTypes.Context & ArbitrumOneTypes.Context & GoerliTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/mumbai/introspectionSchema":
      return import("./sources/mumbai/introspectionSchema") as T;
    
    case ".graphclient/sources/bsc/introspectionSchema":
      return import("./sources/bsc/introspectionSchema") as T;
    
    case ".graphclient/sources/ethereum/introspectionSchema":
      return import("./sources/ethereum/introspectionSchema") as T;
    
    case ".graphclient/sources/matic/introspectionSchema":
      return import("./sources/matic/introspectionSchema") as T;
    
    case ".graphclient/sources/arbitrum-goerli/introspectionSchema":
      return import("./sources/arbitrum-goerli/introspectionSchema") as T;
    
    case ".graphclient/sources/arbitrum-one/introspectionSchema":
      return import("./sources/arbitrum-one/introspectionSchema") as T;
    
    case ".graphclient/sources/goerli/introspectionSchema":
      return import("./sources/goerli/introspectionSchema") as T;
...
const ethereumHandler = new GraphqlHandler({
              name: "ethereum",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/railgun-community/railgun-v2-ethereum"},
              baseDir,
              cache,
              pubsub,
...
const goerliHandler = new GraphqlHandler({
              name: "goerli",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/railgun-community/railgun-v2-goerli"},
              baseDir,
              cache,
              pubsub,
...
const bscHandler = new GraphqlHandler({
              name: "bsc",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/railgun-community/railgun-v2-bsc"},
              baseDir,
              cache,
              pubsub,
...
const maticHandler = new GraphqlHandler({
              name: "matic",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/railgun-community/railgun-v2-polygon"},
              baseDir,
              cache,
              pubsub,
...
const mumbaiHandler = new GraphqlHandler({
              name: "mumbai",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/railgun-community/railgun-v2-mumbai"},
              baseDir,
              cache,
              pubsub,
...
const arbitrumOneHandler = new GraphqlHandler({
              name: "arbitrum-one",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/railgun-community/railgun-v2-arbitrum"},
              baseDir,
              cache,
              pubsub,
...
const arbitrumGoerliHandler = new GraphqlHandler({
              ...
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/railgun-community/railgun-v2-arbitrum-goerli"},
              baseDir,
              cache,
              pubsub,
